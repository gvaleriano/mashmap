      ...
      <div className="container mx-auto p-12">
        <article className="grid grid-cols-1 lg:grid-cols-2 gap-8 relative justify-center items-center md:p-12">
          <div className="space-y-4 flex flex-col">
            ...
            <Button className="w-[314px] h-14 py-4 px-6 bg-blue-900 text-white rounded-full cursor-pointer font-[Sora] font-bold leading-[24px]">Agende sua consulta agora <Image alt="Saiba Mais" src={"./icon-saiba-mais.svg"} width={32} height={32}></Image></Button>
            <Button className="w-[314px] h-14 py-4 px-6 border-blue-900 border-1 bg-transparent text-blue-900 rounded-full cursor-pointer font-[Sora] font-bold leading-[24px]">Acesse a Calculadora FIB-4 <Image alt="Saiba Mais" src={"./icon-saiba-mais.svg"} width={32} height={32}></Image></Button>
          </div>
